...
public class DirectoryCorpus implements DocumentCorpus {
	...
	public void loadDirectory(Path absolutePath)
	{
		this.mDirectoryPath=absolutePath;
	}
	/**
	 ...
	 */
	public void  loadTextFile(String fileExtension) {
		this.registerFileDocumentFactory(fileExtension, TextFileDocument::loadTextFileDocument);
	}
	public void loadJsonDirectory(String fileExtension) {
		this.registerFileDocumentFactory(fileExtension, JsonFileDocument::loadJsonFileDocument);
